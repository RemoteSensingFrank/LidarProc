...
int main(int argc, char **argv)
{
	...
	try{
        ...
        sources.push_back("/mnt/d/LidarProc_Software/LidarProc/data/CEDD_Building.las");
        PotreeConverter pc("", "/mnt/d/LidarProc_Software/LidarProc/data/test1", sources);

		pc.spacing = 0;
		pc.diagonalFraction = 200;
		pc.maxDepth = -1;
